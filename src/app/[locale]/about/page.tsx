    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
        <FadeUp>
          ...
          <p className="font-body text-muted leading-relaxed max-w-3xl text-lg">{t('mission.text')}</p>
        </FadeUp>
      </section>
      ...
      <section className="bg-surface/40 border-y border-border py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeUp>
            ...
            <h2 className="font-display text-4xl sm:text-5xl text-white tracking-widest mb-12">{t('values.title')}</h2>
          </FadeUp>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <FadeUp>
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-white tracking-widest mb-12">{t('team.title')}</h2>
        </FadeUp>
          ...
          {members.map((m, i) => (
            <FadeUp key={m.role} delay={i * 0.07}>
              <div className="bg-card border border-border p-6 group hover:border-cyan/30 transition-colors">
                ...
                <span className="font-mono text-xs text-cyan tracking-widest border border-cyan/20 px-2 py-0.5">{m.department}</span>
              </div>
            </FadeUp>
          ))}
        </div>
      ...
      <section className="bg-surface/40 border-t border-border py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeUp>
            ...
            <h2 className="font-display text-4xl sm:text-5xl text-white tracking-widest mb-12">{t('timeline.title')}</h2>
          </FadeUp>
